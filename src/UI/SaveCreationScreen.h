...
public:
    ...
    explicit SaveCreationScreen(std::string defaultDirectory, WorldMetadata defaults = {}, std::string defaultName = {}, bool lockName = false, bool lockDirectory = false, bool saveAsZipFile = true);
